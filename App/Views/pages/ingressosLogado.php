...
<body>
    ...
    <div class="container">
        <div class="cards">
            <div class="card">
                <img src="App/Views/pages/img/ingresso-semana.jpg" alt="" />
                <div class="card-content">
                    ...
                    <form method="post">
                        <button class="btnAdicionar" type="submit"> Adicionar ao Carrinho </button>
                        <input type="hidden" name="idIngresso" value="5">
            ...
            <div class="card">
                <img src="App/Views/pages/img/ingressos-final-semana.jpg" alt="" />
                <div class="card-content">
                    <span> INGRESSO </span>
                    ...
                    <form method="post">
                        <button class="btnAdicionar" type="submit"> Adicionar ao Carrinho </button>
                        <input type="hidden" name="idIngresso" value="6">
                        <input type="hidden" name="acao" value="Adicionar">
                    </form>  
                </div>
            </div>
            ...
            <div class="card">
                <img src="App/Views/pages/img/ingressos-familia.jpg" alt="" />
                <div class="card-content">
                    <span> INGRESSO </span>
                    <h1> Combo Família</h1>
                    <h3> R$ 160 </h3>
                    ...
                    <form method="post">
                        <button class="btnAdicionar" type="submit"> Adicionar ao Carrinho </button>
                        <input type="hidden" name="idIngresso" value="7">
                        <input type="hidden" name="acao" value="Adicionar">
                    </form>  
                </div>
            </div>
            ...
            <div class="card">
            <img src="App/Views/pages/img/ingressos-diver-comil.jpg" alt="" />
            <div class="card-content">
                <span> INGRESSO </span>
                <h1> Diversão e comilança </h1>
                <h3> R$ 145 </h3>
                <p>
                    Conta com um ingresso + um combo de sua escolha de um nossos restaurantes
                </p>
                <form method="post">
                    <button class="btnAdicionar" type="submit"> Adicionar ao Carrinho </button>
                    <input type="hidden" name="idIngresso" value="8">
                    <input type="hidden" name="acao" value="Adicionar">
                </form>  
            </div>
            </div>
            ...
            <div class="card">
            <img src="App/Views/pages/img/ingressos-parcas.jpg" alt="" />
            <div class="card-content">
                <span> INGRESSO </span>
                <h1> Parças </h1>
                <h3> R$ 160 </h3>
                ...
                <form method="post">
                    <button class="btnAdicionar" type="submit"> Adicionar ao Carrinho </button>
                    <input type="hidden" name="idIngresso" value="9">
                    <input type="hidden" name="acao" value="Adicionar">
                </form>  
            </div>
            </div>
            <div class="card">
            <img src="App/Views/pages/img/ingressos-show.jpg" alt="" />
                <div class="card-content">
                    <span> INGRESSO </span>
                    ...
                    <form method="post">
                        <button class="btnAdicionar" type="submit"> Adicionar ao Carrinho </button>
                        <input type="hidden" name="idIngresso" value="10">
                        <input type="hidden" name="acao" value="Adicionar">
                    </form>  
                </div>
            </div>
            <div class="card">
                <img src="App/Views/pages/img/ingressos-xtudo.jpg" alt="" />
                <div class="card-content">
                    <span> INGRESSO </span>
                    <h1> X-Tudo </h1>
                    <h3> R$ 210 </h3>
                    ...
                    <form method="post">
                        <button class="btnAdicionar" type="submit"> Adicionar ao Carrinho </button>
                        <input type="hidden" name="idIngresso" value="11">
                        <input type="hidden" name="acao" value="Adicionar">
                    </form>  
                </div>
            </div>
